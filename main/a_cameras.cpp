...
void a_cameras() {
    ...
    FisheyeCamera fcam(Point(0, 0, 0), Vector(0, 0, 1), Vector(0, 1, 0));
    Renderer r3(&fcam, 0);

    r3.test_render3(img);
    img.writePNG("fisheye.png");

    EnvironmentCamera ecam(Point(0, 0, 0), Vector(0, 0, 1), Vector(0, 1, 0));
    Renderer r4(&ecam, 0);
    r4.test_render4(img);
    img.writePNG("env.png");
}
